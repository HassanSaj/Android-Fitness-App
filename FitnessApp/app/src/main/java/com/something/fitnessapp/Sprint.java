...
import java.util.concurrent.TimeUnit;
public class Sprint extends AppCompatActivity implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private Sprint.TimerStatus timerStatus = Sprint.TimerStatus.STOPPED;
    ...
    private void loadSettings() {
        ...
        settings.registerOnSharedPreferenceChangeListener((SharedPreferences.OnSharedPreferenceChangeListener) this);
    }
    ...
    private void reset() {
        ...
        timerStatus = Sprint.TimerStatus.STOPPED;
    }
    ...
    private void workstartStop() {
        ...
        breakOrWork = true;
        if (timerStatus ==Sprint.TimerStatus.STOPPED) {
            ...
            timerStatus =Sprint.TimerStatus.STARTED;
    ...
    public void breakAlert() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Sprint.this);
