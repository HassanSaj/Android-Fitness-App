...
public class Skipping extends AppCompatActivity implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private Skipping.TimerStatus timerStatus = Skipping.TimerStatus.STOPPED;
    ...
    private void reset() {
        ...
        timerStatus = Skipping.TimerStatus.STOPPED;
    }
    ...
    private void workstartStop() {
        ...
        breakOrWork = true;
        if (timerStatus == Skipping.TimerStatus.STOPPED) {
            ...
            timerStatus = Skipping.TimerStatus.STARTED;
