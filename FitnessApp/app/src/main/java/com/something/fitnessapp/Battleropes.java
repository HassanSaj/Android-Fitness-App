...
public class Battleropes extends AppCompatActivity implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private Battleropes.TimerStatus timerStatus = Battleropes.TimerStatus.STOPPED;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.battleropes);
    ...
    private void reset() {
        ...
        timerStatus = Battleropes.TimerStatus.STOPPED;
    }
    ...
    private void workstartStop() {
        ...
        breakOrWork = true;
        if (timerStatus == Battleropes.TimerStatus.STOPPED) {
            ...
            timerStatus = Battleropes.TimerStatus.STARTED;
