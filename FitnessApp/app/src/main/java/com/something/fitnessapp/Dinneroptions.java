...
public class Dinneroptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinneroptions);
    ...
    public void formuscle(View view){
        Intent intent=new Intent(this,Dinnerformuscle.class);
        startActivity(intent);
    }
    public void forweight(View view){
        Intent intent=new Intent(this,Dinnerforweightloss.class);
        startActivity(intent);
    }
