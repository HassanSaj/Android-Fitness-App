...
public class WeightAddExercise04 extends AppCompatActivity  implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener{
    TextView textView;
    ...
    private WeightAddExercise04.TimerStatus timerStatus =WeightAddExercise04.TimerStatus.STOPPED;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_add_exercise04);
...
/////////////////////////////retrieving text////////////////////////////////
        ...
        String geturl=pref.getString("weighturi4","");
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(WeightAddExercise04.this);
                SharedPreferences.Editor editor=pref.edit();

                editor.putString("detail",detail);
                editor.putString("weightexercise4",exercise);
                editor.apply();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == IMAGE_PICK_CODE) {
            ...
            editor.putString("weighturi4", String.valueOf(uri));
            editor.apply();
    ...
    private void loadSettings() {
        ...
        settings.registerOnSharedPreferenceChangeListener(WeightAddExercise04.this);
    }
    ...
    private void reset() {
        ...
        timerStatus = WeightAddExercise04.TimerStatus.STOPPED;
    }
    ...
    private void workstartStop() {
        ...
        breakOrWork = true;
        if (timerStatus == WeightAddExercise04.TimerStatus.STOPPED) {
            ...
            timerStatus = WeightAddExercise04.TimerStatus.STARTED;
    ...
    public void breakAlert() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(WeightAddExercise04.this);
