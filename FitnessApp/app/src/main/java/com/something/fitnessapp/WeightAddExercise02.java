...
public class WeightAddExercise02 extends AppCompatActivity  implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener{
    TextView textView;
    ...
    private WeightAddExercise02.TimerStatus timerStatus = WeightAddExercise02.TimerStatus.STOPPED;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_add_exercise02);
...
/////////////////////////////retrieving text////////////////////////////////
        ...
        String geturl=pref.getString("weighturi2","");
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(WeightAddExercise02.this);
                SharedPreferences.Editor editor=pref.edit();

                editor.putString("detail",detail);
                editor.putString("weightexercise2",exercise);
                editor.apply();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == IMAGE_PICK_CODE) {
            ...
            editor.putString("weighturi2", String.valueOf(uri));
            editor.apply();
    ...
    private void loadSettings() {
        ...
        settings.registerOnSharedPreferenceChangeListener(WeightAddExercise02.this);
    }
    ...
    private void reset() {
        ...
        timerStatus = WeightAddExercise02.TimerStatus.STOPPED;
    }
    ...
    private void workstartStop() {
        ...
        breakOrWork = true;
        if (timerStatus ==WeightAddExercise02.TimerStatus.STOPPED) {
            ...
            timerStatus = WeightAddExercise02.TimerStatus.STARTED;
    ...
    public void breakAlert() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(WeightAddExercise02.this);
