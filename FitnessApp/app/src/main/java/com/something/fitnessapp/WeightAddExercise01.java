...
public class WeightAddExercise01 extends AppCompatActivity  implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener{
    TextView textView;
    ...
    private WeightAddExercise01.TimerStatus timerStatus = WeightAddExercise01.TimerStatus.STOPPED;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_add_exercise01);
...
/////////////////////////////retrieving text////////////////////////////////
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(WeightAddExercise01.this);
                SharedPreferences.Editor editor=pref.edit();

                editor.putString("detail",detail);
                editor.putString("weightexercise",exercise);
                editor.apply();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == IMAGE_PICK_CODE) {
            ...
            editor.putString("weighturi", String.valueOf(uri));
            editor.apply();
    ...
    private void loadSettings() {
        ...
        settings.registerOnSharedPreferenceChangeListener(WeightAddExercise01.this);
    }
    ...
    private void reset() {
        ...
        timerStatus = WeightAddExercise01.TimerStatus.STOPPED;
    }
    ...
    private void workstartStop() {
        ...
        breakOrWork = true;
        if (timerStatus == WeightAddExercise01.TimerStatus.STOPPED) {
            ...
            timerStatus = WeightAddExercise01.TimerStatus.STARTED;
    ...
    public void breakAlert() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(WeightAddExercise01.this);
