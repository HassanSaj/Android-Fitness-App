...
public class Pushups extends AppCompatActivity implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private Pushups.TimerStatus timerStatus = Pushups.TimerStatus.STOPPED;
    ...
    private void reset() {
        ...
        timerStatus = Pushups.TimerStatus.STOPPED;
    }
    ...
    private void workstartStop() {
        ...
        breakOrWork = true;
        if (timerStatus == Pushups.TimerStatus.STOPPED) {
            ...
            timerStatus = Pushups.TimerStatus.STARTED;
