...
public class Snacksoptions extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_snacksoptions);
    ...
    public void formuscle(View view){
        Intent intent=new Intent(this,SnacksforMuscle.class);
        startActivity(intent);
    }
    public void forweight(View view){
        Intent intent=new Intent(this,SnacksforWeightloss.class);
        startActivity(intent);
    }
