...
public class MuscleAddExercise04 extends AppCompatActivity {
    TextView textView;
...
/////////////////////////////retrieving text////////////////////////////////
        ...
        String geturl=pref.getString("uri4","");
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(MuscleAddExercise04.this);
                SharedPreferences.Editor editor=pref.edit();

                editor.putString("detail",detail);
                editor.putString("exercise4",exercise);
                editor.apply();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == IMAGE_PICK_CODE) {
            ...
            editor.putString("uri4", String.valueOf(uri));
            editor.apply();
