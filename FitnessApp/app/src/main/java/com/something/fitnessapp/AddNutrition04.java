...
public class AddNutrition04 extends AppCompatActivity {
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_nutrition04);
...
/////////////////////////////retrieving text////////////////////////////////
        ...
        String geturl=pref.getString("nuturi4","");
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(AddNutrition04.this);
                SharedPreferences.Editor editor=pref.edit();

                editor.putString("detail",detail);
                editor.putString("nutexercise4",exercise);
                editor.apply();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == IMAGE_PICK_CODE) {
            ...
            editor.putString("nuturi4", String.valueOf(uri));
            editor.apply();
