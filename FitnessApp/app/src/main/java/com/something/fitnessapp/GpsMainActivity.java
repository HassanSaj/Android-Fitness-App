...
public class GpsMainActivity extends AppCompatActivity implements LocationListener, GpsStatus.Listener {
    ...
    protected void onResume() {
        ...
        if (mLocationManager.getAllProviders().indexOf(LocationManager.GPS_PROVIDER) >= 0) {
            ...
            Log.w("GpsMainActivity", "No GPS location provider found. GPS data display will not be available.");
        }
