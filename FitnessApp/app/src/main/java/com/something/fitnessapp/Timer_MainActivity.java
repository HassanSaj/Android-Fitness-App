...
public class Timer_MainActivity extends AppCompatActivity implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener {
   ...
   // private ImageView imageViewPomodora1, imageViewPomodora2, imageViewPomodora3, imageViewPomodora4;
    ...
    private void loadSettings() {
        ...
        settings.registerOnSharedPreferenceChangeListener(Timer_MainActivity.this);
    }
    ...
    public void breakAlert() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Timer_MainActivity.this);
