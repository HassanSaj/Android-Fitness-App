...
public class WeightAddExercise05 extends AppCompatActivity  implements View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener{
    TextView textView;
    ...
    private WeightAddExercise05.TimerStatus timerStatus =WeightAddExercise05.TimerStatus.STOPPED;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weight_add_exercise05);
...
/////////////////////////////retrieving text////////////////////////////////
        ...
        String geturl=pref.getString("weighturi5","");
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(WeightAddExercise05.this);
                SharedPreferences.Editor editor=pref.edit();

                editor.putString("detail",detail);
                editor.putString("weightexercise5",exercise);
                editor.apply();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == IMAGE_PICK_CODE) {
            ...
            editor.putString("weighturi5", String.valueOf(uri));
            editor.apply();
    ...
    private void loadSettings() {
        ...
        settings.registerOnSharedPreferenceChangeListener(WeightAddExercise05.this);
    }
    ...
    private void reset() {
        ...
        timerStatus = WeightAddExercise05.TimerStatus.STOPPED;
    }
    ...
    private void workstartStop() {
        ...
        breakOrWork = true;
        if (timerStatus == WeightAddExercise05.TimerStatus.STOPPED) {
            ...
            timerStatus = WeightAddExercise05.TimerStatus.STARTED;
    ...
    public void breakAlert() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(WeightAddExercise05.this);
